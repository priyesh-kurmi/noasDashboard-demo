...
export async function GET() {
  return NextResponse.json({
    ...
    storeBreakdown:[
      {store:"Noas Cafe Manchester",totalSpend:12430.5,totalQuantity:3284,invoiceCount:36,topCategory:"Coffee"},
      {store:"Noas Cafe Leeds",totalSpend:10820.0,totalQuantity:2860,invoiceCount:31,topCategory:"Dairy"},
      {store:"Noas Cafe Birmingham",totalSpend:8940.25,totalQuantity:2363,invoiceCount:26,topCategory:"Bakery Supplies"},
    ],
    topProductsPerStore:[
      {store:"Noas Cafe Manchester",topProduct:"Espresso Blend 1kg",spend:2840.0},
      {store:"Noas Cafe Leeds",topProduct:"Whole Milk 2L",spend:2010.5},
      {store:"Noas Cafe Birmingham",topProduct:"Sourdough Loaf",spend:1820.0},
    ],
    filters: {
